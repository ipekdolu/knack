...
export default function AppNav() {
  ...
  return (
    ...
    <nav
      className="fixed inset-x-0 bottom-0 z-10 grid grid-cols-3 gap-1 bg-primary px-2 py-1
                 md:static md:z-auto md:flex md:gap-1 md:bg-transparent md:px-0 md:py-0"
    >
      {ITEMS.map((item) => {
        const active =
